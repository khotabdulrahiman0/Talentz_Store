...
// update the qnt of an itemin the cart
...
const cartSlice = createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        .addCase(updateCartItemQuantity.rejected,(state,action)=>{
            state.loading = false;
            state.error = action.payload?.message || "Failed to update qnt"
        })
        // remove from cart
        ...
        .addCase(removeFromCart.rejected,(state,action)=>{
            state.loading = false;
            state.error = action.payload?.message || "Failed to remove items from cart"
        })
        // merge cart
